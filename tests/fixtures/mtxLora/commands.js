export const uplinkCommands = {
    ...
    getEnergyDayPrevious: {
        hex: {
            dump: '1e1cef9166101003131807100000ddd0000063f5000062da0000d39200380a',
            lrc: '0x0a'
        },
    ...
    getHalfhoursEnergies: {
        hex: {
            dump: '1e105491b710106f0730f1011c0100000000631e5900b8',
            lrc: '0xb8'
        },
        base64: 'HhBUkbcQEG8HMPEBHAEAAAAAYx5ZALg=',
        analog: {
            commands: {
                dataSegment: {
                    name: 'dataSegment',
                    dump: '1e 10 54 91 b7 10 10 6f 07 30 f1 01 1c 01 00 00 00 00',
                    parameters: {
                        segmentationSessionId: 84,
                        segmentIndex: 1,
                        segmentsNumber: 1,
                        isLast: true,
                        data: [
        ...
        mtx: {
            dump: 'b7 10 10 6f 07 30 f1 01 1c 01 00 00 00 00',
            accessLevel: 'UNENCRYPTED (0x00)',
            messageId: 0,
            lrc: 'actual: 0xf0, expected: 0x00',
            commands: {
                getDateTime: {
                    name: 'getHalfhoursEnergies',
                    dump: '6f 07 30 f1 01 1c 01 00 00',
                    parameters: {
                        date: {
                            year: 24,
                            month: 7,
    ...
    getMonthDemand: {
        hex: {
            dump: '1e1bf591081010171218070000ddd0000063f5000062da0000d392003d79',
            lrc: '0x79'
        },
    ...
    getCurrentValues: {
        hex: {
            dump: '1e29f6910910100d20000000000000000000035c410000000003e800000000000000000000000003e8007649',
            lrc: '0x49'
        },
